...
public class traffic_report{
    public static void main(String[] args){
       Scanner sc=new Scanner(System.in);
        ...
        age=sc.nextInt();
        System.out.println("Enter Helmet Status : (0 for invalid and 1 for valid )");
        helmet_stat=sc.nextInt();
        System.out.println("Enter Seatbelt Status : (0 for invalid and 1 for valid )");
        seatbelt_stat=sc.nextInt();
        System.out.println("Enter License Status : (0 for invalid and 1 for valid )");
